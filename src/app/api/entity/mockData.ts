...
export const entityList: IEntity[] = [
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['GD_CONTACT', 'Folder', 'Company', 'Department', 'Person', 'Group']
      },
      {
        name: 'EDITIONDATE',
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$USERRIGHT_BLANK']
      },
      {
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$WG_STAFFCATEGORY']
      },
      {
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$MN_EXTRACATEGORY']
      },
      {
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$VMK_GLOBALGROUP']
      },
      {
        name: 'USR$ACCOUNTKEY',
        type: 'EntityAttribute',
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['GD_CONTACT', 'Department']
      },
      {
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$TYPE_UNITS_PLAN_DEP']
      },
      {
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['FLT_COMPONENTFILTER']
      },
      {
        name: 'DESCRIPTION',
        type: 'StringAttribute',
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['GD_OURCOMPANY', 'OurCompany']
      }
    ]
  },
  {
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$WG_TAXINCOMDEDEDUCTTYPE']
      },
      {
        name: 'USR$EMPLKEY',
        type: 'EntityAttribute',
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['GD_DOCUMENT', 'TgdcDocument']
      },
      {
        name: 'EDITIONDATE',
        type: 'TimeStampAttribute',
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['BN_BANKSTATEMENT', 'DOC_800300_17_BN_BANKSTATEMENT']
      },
      {
        name: 'TRTYPEKEY',
        type: 'IntegerAttribute',
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$SXP_004_ANALITIC']
      },
      {
      ...
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$VBPF_TYPECREDITSUM']
      },
      {
        ...
        semCategories: '',
        calculated: false,
        references: ['USR$VBPF_CONTRACT', 'DOC_985600903_76642254_USR$VBPF_CONTRACT']
      }
    ]
  },
  {
